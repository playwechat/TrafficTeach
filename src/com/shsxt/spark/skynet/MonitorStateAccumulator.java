...
public class MonitorStateAccumulator extends AccumulatorV2<String,String> {
    ...
    public void merge(AccumulatorV2<String, String> other) {
        ...
        /**
         *   abnormalMonitorCount=40|abnormalCameraCount=100|abnormalMonitorCameraInfos="0002":07553,07554~0004:8979,7987~
         */
        myAdd(otherResult);
    }
    ...
    private void myAdd(String v){
        ...
        //v : abnormalMonitorCount=1|abnormalCameraCount=3|abnormalMonitorCameraInfos="0003":07544,07588,07599
